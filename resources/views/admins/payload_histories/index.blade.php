            ...
            <tbody>
                ...
                @else
                    ...
                    <tr class="item-{{ $payloadHistory->id }} payload-history-item">
                        ...
                        <td><a href="{{ route('admin.history.show', ['history' => $payloadHistory->id]) }}">{{ $payloadHistory->log }}</a></td>
                        ...
                        <td class="text-center">
                            ...
                            {{ Form::open([
                                'method' => 'DELETE',
                                'route' => ['admin.history.destroy', 'history' => $payloadHistory, 'page' => request('page')],
