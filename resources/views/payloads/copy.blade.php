    ...
    <div class="form-horizontal form-bordered">
        ...
        <div class="form-group row">
            <div class="col-xs-12">
                ...
                <textarea class="form-control" id="payload_params" rows="7" name="params" placeholder="Enter payload params">{{ $payload->params }}</textarea>
                <div class="has-error">
        ...
        <div class="form-group row">
            <div class="col-xs-12">
                ...
                <textarea class="form-control mt-15" id="payload_content" rows="7" name="content" placeholder="Enter Content message">{{ $payload->content }}</textarea>
                <div class="has-error">
